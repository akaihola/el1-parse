...
photo = Struct(
    ...
    / Array(
        ...
        Struct(
            "photo_id" / Int32ul,
            "unknown0" / OneOf(Int64sl, {-1} | set(range(1, 21))),
            # unknown1 is typically 2 * unknown0 + 4
            "unknown1"
            / OneOf(Int32ul, set(range(3, 14)) | set(range(16, 45, 2)) | {1, 19}),
            # unknown2 is typically unknown0 + 2
            "unknown2" / OneOf(Int32ul, range(1, 23)),
            Check(this.unknown1 >= this.unknown2),
            "unknown3" / Const([1, 1, 0x17, 1], Array(4, Int32ul)),
            "unknown4" / Const([0, 0, 0, 0], Array(4, Int32ul)),
            "unknown5" / Const([1, 0, 1, 4, 2, 0x000200DA, 0x26], Array(7, Int32ul)),
            "unknown6" / Const([0] * 0x1E, Array(0x1E, Int32ul)),
            "unknown7" / Const(0x20C0, Int32ul),
            "unknown8" / Const(0, Int32ul),
            "unknown9" / OneOf(Int32ul, {0, 1}),  # 0 = uncropped, 1 = cropped
            "width_px" / Int32ul,
            "height_px" / Int32ul,
            "crop_left" / OneOf(Int32ul, {0, 4}),  # 0 = uncropped, 4 = cropped),
            "crop_top" / OneOf(Int32ul, {0, 41, 46}),  # 0 = uncropped, 41/46 = cropped
            "unknown10" / OneOf(Int32ul, {0, 1}),  # 1 = uncropped, 0 = cropped
            "unknown11" / Const(0x70001000, Int32ul),
            "unknown12" / Const(0, Int32ul),
            "unknown13" / OneOf(Int32ul, [0, 0x70001000]),
            "unknown14" / Const(0, Int32ul),
            "unknown15"
            / OneOf(PaddedString(0x208, "utf16"), {"frame000_preview.bmp", ""}),
            "unknown16" / Const(0xA78 * b"\0", Bytes(0xA78)),
            "unknown17" / OneOf(Int32ul, {0, 3}),
            "unknown18" / Const(0xC * b"\0", Bytes(0xC)),
